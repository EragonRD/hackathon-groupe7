...
Lancer :  streamlit run app.py   (depuis la racine du repo)
...
from src.retention import retention_target, completion_rate, retention_curve, N_BINS
from src.hotspots import friction_signal, detect_hotspots
from src.recommend import recommend
from src.descriptive import (abandon_rate_global, abandon_rate_per_video,
                             seek_per_video, seek_per_minute, first_pause_time,
                             category_duration, category_analytics)
from src.ennui_interval import (build_interval_target, build_interval_features,
                                evaluate_interval_models,
                                best_model_name as best_interval_name,
                                fit_final as fit_interval_final)
from src.churn_predict import (build_churn_labels, build_churn_features,
