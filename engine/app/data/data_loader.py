"""Chargement et préparation des données de visionnage (tâche 30 — Otman).

Source unique de vérité pour lire les CSV fournis dans `data/` (racine du
repo, partagés par toute l'équipe). Aucune transformation "métier" ici : on
charge, on type, on ajoute la position relative (= position / durée) qui
sert partout ensuite.
"""
from __future__ import annotations
from pathlib import Path
import pandas as pd

# engine/app/data/data_loader.py -> repo root : 3 hops (data -> app -> engine -> root)
