"""Détection des zones d'ennui ("hotspots") + évaluation contre le corrigé (tâche 30 — Otman).
...
Calibration (voir engine/docs/business-3b.md) : les poids et le quantile ont
été choisis pour maximiser le F1 contre le corrigé. Le signal `seek_back` est
de loin le plus discriminant, suivi de la chute de rétention et des abandons.
"""
