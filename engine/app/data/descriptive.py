"""Métriques descriptives pour le dashboard (tâche 30/32 — Otman/Faycal).
...
JAMAIS servir de feature au modèle de prédiction (tâche 31) : ce sont des
reformulations de la cible (fuite). Elles vivent donc ici, séparées de
`features.py`.
"""
