"""Pipeline complet P3-B en ligne de commande (tâches 30/31 — Otman/Amina).

Lance toute l'analyse, mesure la détection contre le corrigé, évalue le
modèle en LOO-CV, et sauvegarde les artefacts dans `engine/outputs/data-3b/` :
...
Usage (depuis `engine/`) :  python scripts/run_analysis_3b.py
"""
import json
import os
import sys
...
OUT = Path(__file__).resolve().parent.parent / "outputs" / "data-3b"
